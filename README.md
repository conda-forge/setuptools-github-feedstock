...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/setuptools-github-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14005&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/setuptools-github-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `setuptools-github` can be installed with:

```
conda install setuptools-github
```

It is possible to list all of the versions of `setuptools-github` available on your platform with:
